...
//                    mBackgroundHandler.post(new Temp2.ImageSaver(reader.acquireNextImage()));
//                }
//            };
//
...
//    }
//
//    void sendOneImage(String name, String image) {
...
////        Records.Field fieldName = new Records.Field("name");
////        Records.Field fieldImage = new Records.Field("image");
////        List<Records.Field> fields = new ArrayList<>();
////        fields.add(fieldImage);
////        fields.add(fieldName);
////        Records.Schema schema = new Records.Schema(fields);
////        Records.Payload payload = new Records.Payload(name, "aaaaaa");
////        records.setPayload(payload);
////        records.setSchema(schema);
//
//        Records.Value value = new Records.Value(name, "bbbb");
//        Records.Record record = new Records.Record(1, value);
//        List<Records.Record> array = new ArrayList<>();
//        array.add(record);
//        Records records = new Records(array);
//
//        Gson gson = new Gson();
//        String test = gson.toJson(records);
...
//        int maxLen = 1000000;
////        for (int i = 0; i < image.length; i += maxLen) {
////            if (i + maxLen > image.length) {
////                sendOneImage(name, Arrays.copyOfRange(image, i, image.length));
////            } else sendOneImage(name, Arrays.copyOfRange(image, i, i + maxLen));
////        }
//        String base64String = Base64.encodeToString(image, Base64.DEFAULT);
//        for (int i = 0; i < base64String.length(); i += maxLen) {
//            if (i + maxLen > base64String.length()) {
//                sendOneImage(name + i, base64String.substring(i));
//            } else sendOneImage(name + i, base64String.substring(i, i + maxLen));
//        }
//    }
//
//    @Override
...
//        }
//        if (bigEnough.size() > 0) {
//            return Collections.min(bigEnough, new Temp2.CompareSizeByArea());
//        } else {
//            return choices[0];
//        }
//    }
